"""
Django settings for cnap project.
...
MIDDLEWARE = [
    # 'cnap.middlewares.HealthCheckMiddleware',
...
ROOT_URLCONF = 'cnap.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'templates'), os.path.join(BASE_DIR, 'cnap/templates')],  # <- add this line
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'cnap.wsgi.application'
